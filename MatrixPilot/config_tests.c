...
#if ((ANALOG_CURRENT_INPUT_CHANNEL != 0) && (USE_INA219 != 0))
	#error("ANALOG_CURRENT_INPUT_CHANNEL != 0 AND USE_INA219 != 0.")
#endif
#if ((ANALOG_VOLTAGE_INPUT_CHANNEL != 0) && (USE_INA219 != 0))
	#error("ANALOG_VOLTAGE_INPUT_CHANNEL != 0 AND USE_INA219 != 0.")
#endif
